...
class ProductCategory(Model, ModelTimeMixin):
    ...
    cat_level = fields.SmallIntField(index=True, description='分类等级,0->1级,1->2级')
    ...
    cat_desc = fields.CharField(max_length=255, null=True, description='分类描述')
...
class ProductCategorySpec(Model, ModelTimeMixin):
    ...
    spec_type = fields.SmallIntField(index=True, description='规格类型  1 销售规格属性 2 展示属性')
